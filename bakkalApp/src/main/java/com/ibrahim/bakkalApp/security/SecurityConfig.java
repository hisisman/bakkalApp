...
public class SecurityConfig {
        ...
        // .ignoringRequestMatchers("/api/update-stock") // CSRF'yi bu endpoint için
        // ignore et
        // )
         ...
         * 
         * @Bean
         * public @Lazy UserDetailsService userDetailsService(UserRepository
         * userRepository) {
         * return new CustomUserDetailsService(userRepository); // Burada
         * CustomUserDetailsService'i kullanıyoruz
         * }
         */
        @Bean
